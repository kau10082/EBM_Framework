...
> > **★ 第③關只判『主旨切題與否』(鐵律,v0.20.1):** 本關**唯一輸出＝兩軸是否同時成立**——切題(疾病軸 ∧ 介入軸 都現)＝清單二候選／離題(缺至少一軸,標明缺哪軸)＝清單三。
